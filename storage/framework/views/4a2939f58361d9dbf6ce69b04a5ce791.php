...
<?php $__env->startSection('page-name', 'history'); ?>
...
<script>
    ...
    async function loadEmployeeSummary() {
        ...
        employeeCards.innerHTML = '<div class="flex justify-center py-8"><span class="loading loading-spinner loading-md"></span></div>';

        try {
            const response = await fetch(`/api/attendance/employee-summary?start_date=${startDate}&end_date=${endDate}`, {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Shadow\benka\resources\views/history.blade.php ENDPATH**/ ?>