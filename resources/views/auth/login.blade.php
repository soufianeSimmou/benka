            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('login') }}" id="login-form" class="space-y-4">
                    ...
                    <div class="form-control">
                        ...
                        <input type="email" id="login-email" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="votre@email.com" class="input input-bordered w-full">
                        @error('email')
                ...
                <!-- Register Form -->
                <form method="POST" action="{{ route('register') }}" id="register-form" class="space-y-4 hidden">
                    @csrf
                    <div class="form-control">
                        <label class="label" for="register-name">
                            <span class="label-text">Nom complet</span>
                        </label>
                        <input type="text" id="register-name" name="name" value="{{ old('name') }}" required autocomplete="name" placeholder="Jean Dupont" class="input input-bordered w-full">
                    </div>
                    ...
                    <div class="form-control">
                        ...
                        <input type="email" id="register-email" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="votre@email.com" class="input input-bordered w-full">
                    </div>
