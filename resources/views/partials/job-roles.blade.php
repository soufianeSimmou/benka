    ...
    <div class="sticky z-[999] bg-base-100 border-b border-base-300" style="top: 0; padding-top: env(safe-area-inset-top, 0px);">
        <div class="max-w-lg mx-auto px-4">
            <div class="flex items-center justify-between py-4">
                <h1 class="text-xl font-bold">Metiers</h1>
                <button id="add-job-btn" type="button" class="inline-flex items-center gap-1 py-2 px-3 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-300">
    ...
    <div class="modal-box">
        ...
        <form id="job-form" class="space-y-4">
            ...
            <div class="modal-action">
                <button type="button" onclick="closeJobModal()" class="py-2.5 px-5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-200">Annuler</button>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div id="job-details-${job.id}" class="transition-all overflow-hidden" style="max-height: 0; margin-top: 0;">
                            ...
                            <div class="flex gap-1 mt-3 pt-3 border-t border-base-300">
                                ...
                                <button type="button" onclick="event.stopPropagation(); confirmDelete(${job.id}, '${escapeHtml(job.name)}')" class="inline-flex items-center justify-center gap-1 py-2 px-3 text-sm font-medium text-red-600 bg-red-50 rounded-lg hover:bg-red-100 focus:outline-none focus:ring-2 focus:ring-red-300 flex-1">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
